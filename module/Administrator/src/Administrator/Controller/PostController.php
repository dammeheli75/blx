...
class PostController extends AbstractActionController
{
    ...
    {
        if ($this->acl()->isAllowed('post', 'management') && $this->acl()->isAllowed('post', 'read')) {
            ...
            // Toolbar
            //
            if ($this->acl()->isAllowed('post', 'create')) {
            ...
            // Transport Read
            if ($this->acl()->isAllowed('post', 'read')) {
            ...
            // Transport Destroy
            if ($this->acl()->isAllowed('post', 'delete')) {
    ...
    {
        if ($this->acl()->isAllowed('post', 'update')) {
            $viewModel = new ViewModel();
            $serviceManager = $this->getEvent()
                ->getApplication()
                ->getServiceManager();
    ...
    {
        if ($this->acl()->isAllowed('post', 'destroy')) {
            $viewModel = new ViewModel();
            $viewModel->setTerminal(true);
            $serviceManager = $this->getEvent()
                ->getApplication()
